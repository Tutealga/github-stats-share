...
useEffect(()=>{
  ...
  return (
    <article id="user-card" className={`border p-5 rounded-lg w-full h-[450px] justify-between flex flex-col ${rank.border} ease-in-out duration-500 transition`}>
     ...
     <div className="flex flex-col text-sm"><div className="flex gap-1 items-center"><FontAwesomeIcon className="w-4 h-4" icon={faStar} /><span>Stars:</span></div><p className="font-bold">24.0k</p></div>
